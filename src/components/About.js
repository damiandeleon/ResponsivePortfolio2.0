            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12 mt-5">
                        <div className="card ps-3 CardPad">
                            <div className="card-header h1 pt-4 pb-3 ps-0">
                                About Me
                    </div>
                            <div className="image-wrapper pr-3 m-4 ms-0">
                                <div>
                                ...
                                <article>
                                    ...
                                    <p>My name is Damian Deleon and I am currently attending The Coding Boot Camp at UT Austin
                                    with a focus on Web Development. I am curently open to new job opportunties in the tech
                                    industry. I am If you are looking to hire a developer who also has proven experience
                                with business sales, marketing, and customer service, please reach out!</p>
                                    ...
                                    <hr />
                                    <h4>Click Below to know more about me.</h4>
                                    <br />
                                </article>
                            </div>
